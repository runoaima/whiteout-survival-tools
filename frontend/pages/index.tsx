                ...
                <section id="materials" className={styles.section}>
                    ...
                    <CategoryGrid
                        items={[
                            ...
                            { label: "英雄ランク計算ツール", href: "/tools/hero-rank", image: "/images/materials/hero_rank/hero_rank.png" },
                            { label: "火晶微粒子計算ツール", href: "/tools/fire-particle", image: "/images/materials/fire_particle/fire_particle.png" },
