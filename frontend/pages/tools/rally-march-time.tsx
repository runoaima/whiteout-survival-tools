...
import Style from "@/styles/tools/rally-march-time.module.css";
    ...
    return (
        <>
            ...
            <PageIntro
                ...
                description="行軍開始から到着までの時間を計算するツールです。"
                toc={
                    [
            ...
            <main className={Style.container}>
                <h1 className={Style.sectionTitle}>集結時間計算ツール</h1>
                ...
                <section id="usage" className={Style.usageSection}>
                    <h2 className={Style.sectionTitle}>使い方</h2>
                    <ol className={Style.usageList}>
                        <li>到着時刻（UTC）を設定します。</li>
                        <li>各部隊ごとに、集結時間と行軍時間を設定します。</li>
                        <li>現在時刻（UTC, offset反映）に基づき、各部隊の開始時刻とカウントダウンが表示されます。</li>
                        <li>カウントダウンが「Go!!」になると、自動的に集結と行軍のカウントが始まります。</li>
                        <li>集結・行軍中はそれぞれの残り時間が表示され、完了すると「到着！」と表示されます。</li>
                    </ol>
                </section>
            </main>
